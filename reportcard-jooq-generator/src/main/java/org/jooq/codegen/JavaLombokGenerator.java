...
/**
 * Uses lombok.Generated as a class annootation instead of (javax.annotation.processing.Generated or javax.annotation.Generated) because
 * <ol>
 *     <li>javax.annotation.Generated only has <code>SOURCE</code> retention, while lombok.Generated <code>CLASS</code> retention. </li>
 *     <li>lombok.Generated is ignored by jacoco when calculating code coverage</li>
 * </ol>
 * Note: lombok is not a dependency of jooq, so if you use this generator, it is YOUR responsibility to ensure your project supports the
