...
public class OrgDao extends DAOImpl<OrgRecord, io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org, Integer> {
     ...
     */
    public OrgDao() {
        super(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG, io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org.class);
    }
    ...
    public OrgDao(Configuration configuration) {
        super(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG, io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org.class, configuration);
    }
    ...
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org> fetchRangeOfOrgId(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_ID, lowerInclusive, upperInclusive);
    }
    ...
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org> fetchByOrgId(Integer... values) {
        return fetch(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_ID, values);
    }
    ...
    public io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org fetchOneByOrgId(Integer value) {
        return fetchOne(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_ID, value);
    }
    ...
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org> fetchRangeOfOrgName(String lowerInclusive, String upperInclusive) {
        return fetchRange(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_NAME, lowerInclusive, upperInclusive);
    }
    ...
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org> fetchByOrgName(String... values) {
        return fetch(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_NAME, values);
    }
    ...
    public io.github.ericdriggs.reportcard.gen.db.tables.pojos.Org fetchOneByOrgName(String value) {
        return fetchOne(io.github.ericdriggs.reportcard.gen.db.tables.Org.ORG.ORG_NAME, value);
    }
}
