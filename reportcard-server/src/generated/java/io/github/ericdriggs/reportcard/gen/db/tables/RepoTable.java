...
public class RepoTable extends TableImpl<RepoRecord> {
    ...
    private static final long serialVersionUID = 836188860;
    ...
    @Override
    public RepoTable as(Table<?> alias) {
        return new RepoTable(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public RepoTable rename(Table<?> name) {
        return new RepoTable(name.getQualifiedName(), null);
    }
