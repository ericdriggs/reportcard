...
public class Keys {
    ...
    public static final ForeignKey<ContextRecord, BranchRecord> CONTEXT_BRANCH_FK = Internal.createForeignKey(Context.CONTEXT, DSL.name("context_branch_fk"), new TableField[] { Context.CONTEXT.BRANCH_FK }, Keys.KEY_BRANCH_PRIMARY, new TableField[] { Branch.BRANCH.BRANCH_ID }, true);
    ...
    public static final ForeignKey<ShaRecord, RepoRecord> REPO_FK = Internal.createForeignKey(Sha.SHA, DSL.name("repo_fk"), new TableField[] { Sha.SHA.REPO_FK }, Keys.KEY_REPO_PRIMARY, new TableField[] { Repo.REPO.REPO_ID }, true);
