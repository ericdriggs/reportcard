...
public class Keys {
    ...
    public static final UniqueKey<JobRecord> KEY_JOB_UQ_JOB_BRANCH_SHA_INFO = Internal.createUniqueKey(Job.JOB, DSL.name("KEY_job_UQ_JOB_BRANCH_SHA_INFO"), new TableField[] { Job.JOB.SHA_FK, Job.JOB.BRANCH_FK, Job.JOB.JOB_INFO_STR }, true);
    ...
    public static final ForeignKey<JobRecord, ShaRecord> FK_JOB_SHA = Internal.createForeignKey(Job.JOB, DSL.name("FK_JOB_SHA"), new TableField[] { Job.JOB.SHA_FK }, Keys.KEY_SHA_PRIMARY, new TableField[] { Sha.SHA.SHA_ID }, true);
