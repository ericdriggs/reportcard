...
public class BranchDao extends DAOImpl<BranchRecord, com.ericdriggs.reportcard.db.tables.pojos.Branch, Integer> {

    /**
     * Create a new BranchDao without any configuration
     */
    public BranchDao() {
        super(Branch.BRANCH, com.ericdriggs.reportcard.db.tables.pojos.Branch.class);
    }
    ...
    public BranchDao(Configuration configuration) {
        super(Branch.BRANCH, com.ericdriggs.reportcard.db.tables.pojos.Branch.class, configuration);
    }
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Branch> fetchByRepoFk(Integer... values) {
