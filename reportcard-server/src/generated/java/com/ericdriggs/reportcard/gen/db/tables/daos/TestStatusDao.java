...
public class TestStatusDao extends DAOImpl<TestStatusRecord, com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus, Byte> {

    /**
     * Create a new TestStatusDao without any configuration
     */
    public TestStatusDao() {
        super(TestStatus.TEST_STATUS, com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus.class);
    }
    ...
    public TestStatusDao(Configuration configuration) {
        super(TestStatus.TEST_STATUS, com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus.class, configuration);
    }

    @Override
    public Byte getId(com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus object) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus> fetchRangeOfTestStatusId(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus> fetchByTestStatusId(Byte... values) {
     ...
     */
    public com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus fetchOneByTestStatusId(Byte value) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus> fetchRangeOfTestStatusName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.TestStatus> fetchByTestStatusName(String... values) {
