...
public class RepoDao extends DAOImpl<RepoRecord, com.ericdriggs.reportcard.gen.db.tables.pojos.Repo, Integer> {

    /**
     * Create a new RepoDao without any configuration
     */
    public RepoDao() {
        super(Repo.REPO, com.ericdriggs.reportcard.gen.db.tables.pojos.Repo.class);
    }
    ...
    public RepoDao(Configuration configuration) {
        super(Repo.REPO, com.ericdriggs.reportcard.gen.db.tables.pojos.Repo.class, configuration);
    }

    @Override
    public Integer getId(com.ericdriggs.reportcard.gen.db.tables.pojos.Repo object) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchRangeOfRepoId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchByRepoId(Integer... values) {
     ...
     */
    public com.ericdriggs.reportcard.gen.db.tables.pojos.Repo fetchOneByRepoId(Integer value) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchRangeOfRepoName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchByRepoName(String... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchRangeOfOrgFk(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.gen.db.tables.pojos.Repo> fetchByOrgFk(Integer... values) {
