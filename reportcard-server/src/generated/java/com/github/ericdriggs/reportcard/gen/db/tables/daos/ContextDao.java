...
public class ContextDao extends DAOImpl<ContextRecord, io.github.ericdriggs.reportcard.gen.db.tables.pojos.Context, Long> {
     ...
     */
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Context> fetchRangeOfApplication(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Context> fetchByApplication(String... values) {
     ...
     */
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Context> fetchRangeOfPipeline(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<io.github.ericdriggs.reportcard.gen.db.tables.pojos.Context> fetchByPipeline(String... values) {
