...
public class PipelineDashboardHtmlHelper {
    ...
    public static String renderPipelineDashboard(List<PipelineDashboardMetrics> metrics, String pipeline) {
    ...
    private static String renderPipelineDashboardMain(List<PipelineDashboardMetrics> metrics, String pipeline) {
        StringBuilder sb = new StringBuilder();
        sb.append("<h1>Pipeline Dashboard - ").append(pipeline).append("</h1>").append(ls);
        sb.append(renderPipelineTable(metrics));
        return sb.toString();
    }

    private static String renderPipelineTable(List<PipelineDashboardMetrics> metrics) {
        StringBuilder sb = new StringBuilder();
        ...
        for (PipelineDashboardMetrics metric : metrics) {
            sb.append("<tr>").append(ls);
