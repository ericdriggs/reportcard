...
public class MetadataJsonController {
    ...
    public ResponseEntity<Map<Execution,Set<Stage>>> getExecution (
            ...
            @RequestParam(required = false) Map<String,String> metadataFilters) {
        return new ResponseEntity<>(reportCardService.getExecutionStages(org, repo, branch, sha, metadataFilters, externalExecutionId), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<Stage,Set<TestResult>>> getStages (
            ...
            @RequestParam(required = false) Map<String,String> metadataFilters) {
        return new ResponseEntity<>(reportCardService.getStagesTestResults(org, repo, branch, sha, metadataFilters, executionName), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<Stage,Set<TestResult>>> getStage (
            ...
            @RequestParam(required = false) Map<String,String> metadataFilters) {
        return new ResponseEntity<>(reportCardService.getStageTestResults(org, repo, branch, sha, metadataFilters, executionName, stage), HttpStatus.OK);
    }
