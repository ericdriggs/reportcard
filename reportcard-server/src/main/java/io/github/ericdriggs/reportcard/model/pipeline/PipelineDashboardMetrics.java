...
@Jacksonized
@Value
public class PipelineDashboardMetrics {
    String company;
    String org;
    String repo;
    String branch;
    ...
    public static List<PipelineDashboardMetrics> fromCompanyGraphs(List<CompanyGraph> companyGraphs, PipelineDashboardRequest request) {
        List<PipelineDashboardMetrics> results = new ArrayList<>();
                ...
                for (RepoGraph repoGraph : emptyIfNull(orgGraph.repos())) {
                    for (BranchGraph branchGraph : emptyIfNull(repoGraph.branches())) {
                        for (JobGraph jobGraph : emptyIfNull(branchGraph.jobs())) {
                            ...
                            results.add(PipelineDashboardMetrics.builder()
