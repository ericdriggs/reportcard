...
public class OrgReposBranchesCacheMap extends AbstractAsyncCacheMap<CompanyOrg, Map<Org,Map<Repo, Set<Branch>>>, OrgReposBranchesCache> {

    public static OrgReposBranchesCacheMap INSTANCE = new OrgReposBranchesCacheMap();
    @Override
    protected OrgReposBranchesCache newCache(CompanyOrg key) {
