...
In GraphService.java, find the method `getPipelineDashboardCompanyGraphs(JobDashboardRequest request)` (defined at line 593).

In the JOOQ query within this method, add to the SELECT list:
...
- GraphService query SELECTs TEST_RESULT.START_TIME and TEST_RESULT.END_TIME in getPipelineDashboardCompanyGraphs method
