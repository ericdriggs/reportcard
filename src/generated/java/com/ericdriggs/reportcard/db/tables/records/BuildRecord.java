...
public class BuildRecord extends UpdatableRecordImpl<BuildRecord> implements Record4<Long, Integer, Integer, LocalDateTime> {

    private static final long serialVersionUID = -55442262;
    ...
    @Override
    public BuildRecord values(Long value1, Integer value2, Integer value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BuildRecord(Long buildId, Integer appBranchFk, Integer appBranchBuildOrdinal, LocalDateTime buildCreated) {
        super(Build.BUILD);
