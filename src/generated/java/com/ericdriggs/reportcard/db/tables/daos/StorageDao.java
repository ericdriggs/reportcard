...
public class StorageDao extends DAOImpl<StorageRecord, com.ericdriggs.reportcard.db.tables.pojos.Storage, Integer> {

    /**
     * Create a new StorageDao without any configuration
     */
    public StorageDao() {
        super(Storage.STORAGE, com.ericdriggs.reportcard.db.tables.pojos.Storage.class);
    }
    ...
    public StorageDao(Configuration configuration) {
        super(Storage.STORAGE, com.ericdriggs.reportcard.db.tables.pojos.Storage.class, configuration);
    }
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfBuildStageFk(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByBuildStageFk(Long... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfStorageTypeFk(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByStorageTypeFk(Byte... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfS3Bucket(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByS3Bucket(String... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfS3FolderPath(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByS3FolderPath(String... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfS3FileName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByS3FileName(String... values) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchRangeOfS3FileMatcher(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.ericdriggs.reportcard.db.tables.pojos.Storage> fetchByS3FileMatcher(String... values) {
