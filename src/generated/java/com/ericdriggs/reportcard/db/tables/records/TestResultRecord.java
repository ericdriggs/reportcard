...
public class TestResultRecord extends UpdatableRecordImpl<TestResultRecord> implements Record10<Long, Long, Integer, Integer, Integer, Integer, BigDecimal, LocalDateTime, Byte, Byte> {

    private static final long serialVersionUID = -1749227797;
    ...
    @Override
    public Row10<Long, Long, Integer, Integer, Integer, Integer, BigDecimal, LocalDateTime, Byte, Byte> valuesRow() {
    ...
    @Override
    public TestResultRecord value10(Byte value) {
        setHasSkip(value);
        return this;
    }

    @Override
    public TestResultRecord values(Long value1, Long value2, Integer value3, Integer value4, Integer value5, Integer value6, BigDecimal value7, LocalDateTime value8, Byte value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestResultRecord(Long testResultId, Long buildStageFk, Integer tests, Integer skipped, Integer error, Integer failure, BigDecimal time, LocalDateTime testResultCreated, Byte isSuccess, Byte hasSkip) {
        super(TestResult.TEST_RESULT);
