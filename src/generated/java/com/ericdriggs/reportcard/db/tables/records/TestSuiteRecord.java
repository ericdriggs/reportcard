...
public class TestSuiteRecord extends UpdatableRecordImpl<TestSuiteRecord> implements Record10<Long, Long, String, Integer, Integer, Integer, Integer, BigDecimal, Byte, Byte> {

    private static final long serialVersionUID = 1755742326;
    ...
    @Override
    public Row10<Long, Long, String, Integer, Integer, Integer, Integer, BigDecimal, Byte, Byte> valuesRow() {
    ...
    @Override
    public TestSuiteRecord values(Long value1, Long value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, BigDecimal value8, Byte value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestSuiteRecord(Long testSuiteId, Long testResultFk, String package_, Integer tests, Integer skipped, Integer error, Integer failure, BigDecimal time, Byte isSuccess, Byte hasSkip) {
        super(TestSuite.TEST_SUITE);
