...
public class TestSuiteRecord extends UpdatableRecordImpl<TestSuiteRecord> implements Record12<Long, Long, Integer, Integer, Integer, Integer, BigDecimal, String, String, String, Byte, Byte> {

    private static final long serialVersionUID = -1678170384;
    ...
    @Override
    public Row12<Long, Long, Integer, Integer, Integer, Integer, BigDecimal, String, String, String, Byte, Byte> valuesRow() {
    ...
    @Override
    public TestSuiteRecord value11(Byte value) {
        setIsSuccess(value);
        return this;
    }

    @Override
    public TestSuiteRecord value12(Byte value) {
        setHasSkip(value);
        return this;
    }

    @Override
    public TestSuiteRecord values(Long value1, Long value2, Integer value3, Integer value4, Integer value5, Integer value6, BigDecimal value7, String value8, String value9, String value10, Byte value11, Byte value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestSuiteRecord(Long testSuiteId, Long testResultFk, Integer tests, Integer skipped, Integer error, Integer failure, BigDecimal time, String package_, String group, String properties, Byte isSuccess, Byte hasSkip) {
        super(TestSuite.TEST_SUITE);
