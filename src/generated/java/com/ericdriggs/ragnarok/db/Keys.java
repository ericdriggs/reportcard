...
import com.ericdriggs.ragnarok.db.tables.records.TestResultRecord;
...
public class Keys {
    ...
    public static final UniqueKey<AppRecord> KEY_APP_BRANCH_APP_IDX = UniqueKeys0.KEY_APP_BRANCH_APP_IDX;
    ...
    public static final UniqueKey<BuildRecord> KEY_BUILD_APP_BUILD_IDX = UniqueKeys0.KEY_BUILD_APP_BUILD_IDX;
    ...
    public static final UniqueKey<StageRecord> KEY_STAGE_APP_STAGE_IDX = UniqueKeys0.KEY_STAGE_APP_STAGE_IDX;
    ...
    public static final ForeignKey<AppRecord, BranchRecord> BRANCH_FK = ForeignKeys0.BRANCH_FK;
    public static final ForeignKey<BranchRecord, RepoRecord> REPO_FK = ForeignKeys0.REPO_FK;
    public static final ForeignKey<BuildRecord, AppRecord> APP_FK = ForeignKeys0.APP_FK;
    ...
    public static final ForeignKey<RepoRecord, OrgRecord> ORG_FK = ForeignKeys0.ORG_FK;
    public static final ForeignKey<StageRecord, AppRecord> STAGE_APP_FK = ForeignKeys0.STAGE_APP_FK;
    ...
    private static class UniqueKeys0 {
        public static final UniqueKey<AppRecord> KEY_APP_PRIMARY = Internal.createUniqueKey(App.APP, "KEY_app_PRIMARY", new TableField[] { App.APP.ID }, true);
        public static final UniqueKey<AppRecord> KEY_APP_BRANCH_APP_IDX = Internal.createUniqueKey(App.APP, "KEY_app_branch_app_idx", new TableField[] { App.APP.BRANCH_FK, App.APP.ID }, true);
        public static final UniqueKey<AppRecord> KEY_APP_NAME_UNIQUE = Internal.createUniqueKey(App.APP, "KEY_app_name_UNIQUE", new TableField[] { App.APP.NAME }, true);
        public static final UniqueKey<BranchRecord> KEY_BRANCH_PRIMARY = Internal.createUniqueKey(Branch.BRANCH, "KEY_branch_PRIMARY", new TableField[] { Branch.BRANCH.ID }, true);
        public static final UniqueKey<BranchRecord> KEY_BRANCH_REPO_BRANCH_IDX = Internal.createUniqueKey(Branch.BRANCH, "KEY_branch_repo_branch_idx", new TableField[] { Branch.BRANCH.REPO_FK, Branch.BRANCH.ID }, true);
        public static final UniqueKey<BranchRecord> KEY_BRANCH_NAME_UNIQUE = Internal.createUniqueKey(Branch.BRANCH, "KEY_branch_name_UNIQUE", new TableField[] { Branch.BRANCH.NAME }, true);
        public static final UniqueKey<BuildRecord> KEY_BUILD_PRIMARY = Internal.createUniqueKey(Build.BUILD, "KEY_build_PRIMARY", new TableField[] { Build.BUILD.ID }, true);
        public static final UniqueKey<BuildRecord> KEY_BUILD_APP_BUILD_IDX = Internal.createUniqueKey(Build.BUILD, "KEY_build_app_build_idx", new TableField[] { Build.BUILD.APP_FK, Build.BUILD.ID }, true);
        ...
        public static final UniqueKey<OrgRecord> KEY_ORG_PRIMARY = Internal.createUniqueKey(Org.ORG, "KEY_org_PRIMARY", new TableField[] { Org.ORG.ID }, true);
        public static final UniqueKey<OrgRecord> KEY_ORG_IDX_ORG_NAME = Internal.createUniqueKey(Org.ORG, "KEY_org_idx_org_name", new TableField[] { Org.ORG.NAME }, true);
        public static final UniqueKey<RepoRecord> KEY_REPO_PRIMARY = Internal.createUniqueKey(Repo.REPO, "KEY_repo_PRIMARY", new TableField[] { Repo.REPO.ID }, true);
        public static final UniqueKey<RepoRecord> KEY_REPO_ORG_REPO_IDX = Internal.createUniqueKey(Repo.REPO, "KEY_repo_org_repo_idx", new TableField[] { Repo.REPO.ID, Repo.REPO.ORG_FK }, true);
        public static final UniqueKey<RepoRecord> KEY_REPO_NAME_UNIQUE = Internal.createUniqueKey(Repo.REPO, "KEY_repo_name_UNIQUE", new TableField[] { Repo.REPO.NAME }, true);
        public static final UniqueKey<StageRecord> KEY_STAGE_PRIMARY = Internal.createUniqueKey(Stage.STAGE, "KEY_stage_PRIMARY", new TableField[] { Stage.STAGE.ID }, true);
        public static final UniqueKey<StageRecord> KEY_STAGE_APP_STAGE_IDX = Internal.createUniqueKey(Stage.STAGE, "KEY_stage_app_stage_idx", new TableField[] { Stage.STAGE.APP_FK, Stage.STAGE.ID }, true);
        public static final UniqueKey<StageRecord> KEY_STAGE_NAME_UNIQUE = Internal.createUniqueKey(Stage.STAGE, "KEY_stage_name_UNIQUE", new TableField[] { Stage.STAGE.NAME }, true);
        public static final UniqueKey<StorageRecord> KEY_STORAGE_PRIMARY = Internal.createUniqueKey(Storage.STORAGE, "KEY_storage_PRIMARY", new TableField[] { Storage.STORAGE.ID }, true);
        ...
        public static final UniqueKey<TestCaseRecord> KEY_TEST_CASE_PRIMARY = Internal.createUniqueKey(TestCase.TEST_CASE, "KEY_test_case_PRIMARY", new TableField[] { TestCase.TEST_CASE.ID }, true);
        public static final UniqueKey<TestResultRecord> KEY_TEST_RESULT_PRIMARY = Internal.createUniqueKey(TestResult.TEST_RESULT, "KEY_test_result_PRIMARY", new TableField[] { TestResult.TEST_RESULT.ID }, true);
        public static final UniqueKey<TestStatusRecord> KEY_TEST_STATUS_PRIMARY = Internal.createUniqueKey(TestStatus.TEST_STATUS, "KEY_test_status_PRIMARY", new TableField[] { TestStatus.TEST_STATUS.ID }, true);
        public static final UniqueKey<TestSuiteRecord> KEY_TEST_SUITE_PRIMARY = Internal.createUniqueKey(TestSuite.TEST_SUITE, "KEY_test_suite_PRIMARY", new TableField[] { TestSuite.TEST_SUITE.ID }, true);
    }

    private static class ForeignKeys0 {
        public static final ForeignKey<AppRecord, BranchRecord> BRANCH_FK = Internal.createForeignKey(Keys.KEY_BRANCH_PRIMARY, App.APP, "branch_fk", new TableField[] { App.APP.BRANCH_FK }, true);
        public static final ForeignKey<BranchRecord, RepoRecord> REPO_FK = Internal.createForeignKey(Keys.KEY_REPO_PRIMARY, Branch.BRANCH, "repo_fk", new TableField[] { Branch.BRANCH.REPO_FK }, true);
        public static final ForeignKey<BuildRecord, AppRecord> APP_FK = Internal.createForeignKey(Keys.KEY_APP_PRIMARY, Build.BUILD, "app_fk", new TableField[] { Build.BUILD.APP_FK }, true);
        ...
        public static final ForeignKey<RepoRecord, OrgRecord> ORG_FK = Internal.createForeignKey(Keys.KEY_ORG_PRIMARY, Repo.REPO, "org_fk", new TableField[] { Repo.REPO.ORG_FK }, true);
        public static final ForeignKey<StageRecord, AppRecord> STAGE_APP_FK = Internal.createForeignKey(Keys.KEY_APP_PRIMARY, Stage.STAGE, "stage_app_fk", new TableField[] { Stage.STAGE.APP_FK }, true);
        ...
        public static final ForeignKey<TestCaseRecord, TestStatusRecord> FK_TEST_CASE_TEST_STATUS = Internal.createForeignKey(Keys.KEY_TEST_STATUS_PRIMARY, TestCase.TEST_CASE, "fk_test_case_test_status", new TableField[] { TestCase.TEST_CASE.STATUS_FK }, true);
