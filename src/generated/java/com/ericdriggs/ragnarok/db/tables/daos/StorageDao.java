...
public class StorageDao extends DAOImpl<StorageRecord, com.ericdriggs.ragnarok.db.tables.pojos.Storage, UInteger> {
    ...
    @Override
    public UInteger getId(com.ericdriggs.ragnarok.db.tables.pojos.Storage object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Storage> fetchRangeOfId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Storage> fetchById(UInteger... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.Storage fetchOneById(UInteger value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Storage> fetchRangeOfBuildStageFk(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Storage> fetchByBuildStageFk(ULong... values) {
