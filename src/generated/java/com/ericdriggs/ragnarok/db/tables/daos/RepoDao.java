...
public class RepoDao extends DAOImpl<RepoRecord, com.ericdriggs.ragnarok.db.tables.pojos.Repo, UInteger> {
    ...
    @Override
    public UInteger getId(com.ericdriggs.ragnarok.db.tables.pojos.Repo object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Repo> fetchRangeOfId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Repo> fetchById(UInteger... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.Repo fetchOneById(UInteger value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Repo> fetchRangeOfOrgFk(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Repo> fetchByOrgFk(UInteger... values) {
