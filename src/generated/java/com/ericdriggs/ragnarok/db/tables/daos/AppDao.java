...
public class AppDao extends DAOImpl<AppRecord, com.ericdriggs.ragnarok.db.tables.pojos.App, Integer> {
    ...
    @Override
    public Integer getId(com.ericdriggs.ragnarok.db.tables.pojos.App object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.App> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.App> fetchById(Integer... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.App fetchOneById(Integer value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.App> fetchRangeOfBranchFk(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.App> fetchByBranchFk(Integer... values) {
