...
public class TestResultDao extends DAOImpl<TestResultRecord, com.ericdriggs.ragnarok.db.tables.pojos.TestResult, Long> {
    ...
    @Override
    public Long getId(com.ericdriggs.ragnarok.db.tables.pojos.TestResult object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchById(Long... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.TestResult fetchOneById(Long value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfBuildStageFk(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchByBuildStageFk(Long... values) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfTests(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchByTests(Integer... values) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfSkipped(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchBySkipped(Integer... values) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfError(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchByError(Integer... values) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchRangeOfFailure(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestResult> fetchByFailure(Integer... values) {
