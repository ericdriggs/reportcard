...
public class BranchDao extends DAOImpl<BranchRecord, com.ericdriggs.ragnarok.db.tables.pojos.Branch, UInteger> {
    ...
    @Override
    public UInteger getId(com.ericdriggs.ragnarok.db.tables.pojos.Branch object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Branch> fetchRangeOfId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Branch> fetchById(UInteger... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.Branch fetchOneById(UInteger value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Branch> fetchRangeOfRepoFk(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Branch> fetchByRepoFk(UInteger... values) {
