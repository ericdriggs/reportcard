...
public class StageDao extends DAOImpl<StageRecord, com.ericdriggs.ragnarok.db.tables.pojos.Stage, UInteger> {
    ...
    @Override
    public UInteger getId(com.ericdriggs.ragnarok.db.tables.pojos.Stage object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Stage> fetchRangeOfId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Stage> fetchById(UInteger... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.Stage fetchOneById(UInteger value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Stage> fetchRangeOfAppFk(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.Stage> fetchByAppFk(UInteger... values) {
