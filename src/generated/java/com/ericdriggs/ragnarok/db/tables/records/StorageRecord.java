...
public class StorageRecord extends UpdatableRecordImpl<StorageRecord> implements Record8<UInteger, ULong, String, Byte, String, String, String, String> {

    private static final long serialVersionUID = -978889602;

    /**
     * Setter for <code>ragnarok.storage.id</code>.
     */
    public StorageRecord setId(UInteger value) {
        set(0, value);
        return this;
    }
     ...
     */
    public StorageRecord setBuildStageFk(ULong value) {
        set(1, value);
        return this;
    }
    ...
    @Override
    public Row8<UInteger, ULong, String, Byte, String, String, String, String> valuesRow() {
    ...
    @Override
    public StorageRecord value1(UInteger value) {
        setId(value);
        return this;
    }

    @Override
    public StorageRecord value2(ULong value) {
    ...
    @Override
    public StorageRecord values(UInteger value1, ULong value2, String value3, Byte value4, String value5, String value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StorageRecord(UInteger id, ULong buildStageFk, String label, Byte storageTypeFk, String s3Bucket, String s3FolderPath, String s3FileName, String s3FileMatcher) {
        super(Storage.STORAGE);
