...
public class TestCaseDao extends DAOImpl<TestCaseRecord, com.ericdriggs.ragnarok.db.tables.pojos.TestCase, ULong> {
    ...
    @Override
    public ULong getId(com.ericdriggs.ragnarok.db.tables.pojos.TestCase object) {
        return object.getId();
    }
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestCase> fetchRangeOfId(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestCase> fetchById(ULong... values) {
     ...
     */
    public com.ericdriggs.ragnarok.db.tables.pojos.TestCase fetchOneById(ULong value) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestCase> fetchRangeOfTestSuiteFk(ULong lowerInclusive, ULong upperInclusive) {
     ...
     */
    public List<com.ericdriggs.ragnarok.db.tables.pojos.TestCase> fetchByTestSuiteFk(ULong... values) {
